...
> **published** (`@rtrentjones/greenlight@0.2.20`, OIDC), the wrapper consumes it from npm, and both
...
| Greenlight framework | ✅ published `@rtrentjones/greenlight@0.2.20` (OIDC) | done |
