...
module "bamcp_tunnel" {
  source = "git::https://github.com/RTrentJones/greenlight.git//infra/modules/tunnel?ref=v0.5.0"
...
module "bamcp_network" {
  source = "git::https://github.com/RTrentJones/greenlight.git//infra/modules/oci-network?ref=v0.5.0"
...
module "bamcp_instance" {
  source = "git::https://github.com/RTrentJones/greenlight.git//infra/modules/oci-container-instance?ref=v0.5.0"
...
module "bamcp_dns" {
  source = "git::https://github.com/RTrentJones/greenlight.git//infra/modules/tool?ref=v0.5.0"
