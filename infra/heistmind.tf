...
module "heistmind_supabase" {
  source = "git::https://github.com/RTrentJones/greenlight.git//infra/modules/supabase?ref=v0.2.27"
...
module "keepalive" {
  source = "git::https://github.com/RTrentJones/greenlight.git//infra/modules/keepalive?ref=v0.2.27"
