...
module "heistmind_supabase" {
  source = "git::https://github.com/RTrentJones/greenlight.git//infra/modules/supabase?ref=v0.6.1"
...
module "keepalive" {
  source = "git::https://github.com/RTrentJones/greenlight.git//infra/modules/keepalive?ref=v0.6.1"
